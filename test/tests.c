...
void test_mux_4_to_2(void) {
    int s0 = 0;
    int s1 = 0;
    TEST_ASSERT_EQUAL(0, mux_4_to_2(0, 0, 0, 0, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_4_to_2(1, 0, 0, 0, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_4_to_2(0, 0, 0, 0, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_4_to_2(0, 1, 0, 0, s1, s0)); //failed

    s0 = 0;
    s1 = 1;
    TEST_ASSERT_EQUAL(0, mux_4_to_2(0, 0, 0, 0, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_4_to_2(0, 0, 1, 0, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_4_to_2(0, 0, 0, 0, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_4_to_2(0, 0, 0, 1, s1, s0));

}

void test_mux_8_to_3(void) {
    int s0 = 0;
    int s1 = 0;
    int s2 = 0;

    TEST_ASSERT_EQUAL(0, mux_8_to_3(0, 1, 1, 1, 1, 1, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(1, 0, 0, 0, 0, 0, 0, 0, s2, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 0, 1, 1, 1, 1, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 1, 0, 0, 0, 0, 0, 0, s2, s1, s0));

    s1 = 1;
    s0 = 0;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 0, 1, 1, 1, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 1, 0, 0, 0, 0, 0, s2, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 1, 0, 1, 1, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 0, 1, 0, 0, 0, 0, s2, s1, s0));

    s2 = 1;
    s1 = 0;
    s0 = 0;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 1, 1, 0, 1, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 0, 0, 1, 0, 0, 0, s2, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 1, 1, 1, 0, 1, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 0, 0, 0, 1, 0, 0, s2, s1, s0));

    s1 = 1;
    s0 = 0;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 1, 1, 1, 1, 0, 1, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 0, 0, 0, 0, 1, 0, s2, s1, s0));

    s0 = 1;
    TEST_ASSERT_EQUAL(0, mux_8_to_3(1, 1, 1, 1, 1, 1, 1, 0, s2, s1, s0));
    TEST_ASSERT_EQUAL(1, mux_8_to_3(0, 0, 0, 0, 0, 0, 0, 1, s2, s1, s0));
}
...
int main(void) {
    ...
    RUN_TEST(test_mux_4_to_2);
    RUN_TEST(test_mux_8_to_3);
